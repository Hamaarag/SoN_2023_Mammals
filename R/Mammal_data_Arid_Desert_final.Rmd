...
write.csv(coefp, "../output/arid/coefficients_Arid_Desert.csv")
```
...
plot_model_interaction(P.anal = Capra.nubiana.two.sites, m = glm.Capra.nubiana, eff2plot = "rescaled_Time.Diff", modvar2plot = "Distance_agri_rescaled", plot_points = FALSE, export_plot = TRUE, outpath = "../output", fontname = "Almoni ML v5 AAA")
...
plot_model_interaction(P.anal = env_data, m = glm.Gazella.dorcas, eff2plot = "rescaled_Time.Diff", modvar2plot = "Distance_agri_rescaled", plot_points = FALSE, export_plot = TRUE, outpath = "../output", fontname = "Almoni ML v5 AAA", legend_position = "bottom")
