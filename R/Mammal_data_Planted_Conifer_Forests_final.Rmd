...
write.csv(coefp, "../output/forest/coefficients_Subunit_Planted_Conifer_Forest.csv")
...
plot_model_effect(P.anal = env_data[Subunit!="Carmel"][, Canis.lupus:=as.numeric(Canis.lupus)], m = glm.Canis.lupus, eff2plot = "Subunit", plot_points=TRUE, plot_residuals=FALSE, export_plot=TRUE, ylabel = NULL, fontname = "Almoni ML v5 AAA", fontsize=22, pdf_width=160, outpath = "../output/forest/", y_cutoff = 4)
```
...
plot_model_effect(P.anal = env_data, m = glm.Gazella.gazella, eff2plot = "Subunit", plot_points=TRUE, plot_residuals=FALSE, export_plot=TRUE, ylabel = NULL, fontname = "Almoni ML v5 AAA", fontsize=22, pdf_width=160, outpath = "../output/forest/")
...
plot_model_effect(P.anal = env_data, m = glm.Hystrix.indica, eff2plot = "Subunit", plot_points=TRUE, plot_residuals=FALSE, export_plot=TRUE, ylabel = NULL, fontname = "Almoni ML v5 AAA", fontsize=22, pdf_width=160, outpath = "../output/forest/")
...
plot_model_effect(P.anal = env_data, m = glm.Sus.scrofa, eff2plot = "Subunit", plot_points=TRUE, plot_residuals=FALSE, export_plot=TRUE, ylabel = NULL, fontname = "Almoni ML v5 AAA", fontsize=22, pdf_width=160, outpath = "../output/forest/")
...
write.csv(coefp, "..output/forest/coefficients_Subunit_interaction_Planted_Conifer_Forest.csv")
```
...
plot_model_interaction(P.anal = env_data, m = glm.Sus.scrofa, eff2plot = "rescaled_Time.Diff", modvar2plot = "Subunit", plot_points=FALSE, plot_residuals=FALSE, export_plot=TRUE, ylabel = NULL, fontname = "Almoni ML v5 AAA", fontsize=22, pdf_width=160, outpath = "../output/forest/", legend_position = "bottom")
```
...
plot_model_interaction(P.anal = env_data, m = glm.Canis.aureus, eff2plot = "rescaled_Time.Diff", modvar2plot = "Subunit", plot_points=FALSE, plot_residuals=FALSE, export_plot=TRUE, ylabel = NULL, fontname = "Almoni ML v5 AAA", fontsize=22, pdf_width=160, outpath = "../output/forest/", legend_position = "bottom")
```
